        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title"> {!! __('admin.Brand') !!}</h5>
                    ...
                    <div class="card-datatable table-responsive">
                        ...
                        <table id="products-table"
                            ...
                            @endif --}}
                                ...
                                @foreach ($brand as $warehouse)
                                    <tr class="odd">
                                        <td>
                                            <input type="checkbox" value="{{ $warehouse->id }}"
                                        ...
                                        <td>
                                            <div class="d-inline-block text-nowrap">
                                                <a href="{{ route('brand.edit', $warehouse->id) }}">
                                                    <button class="btn btn-sm btn-icon" title="{{ __('admin.Edit') }}">
                                                        <i class="bx bxs-edit"></i>
                                                    </button>
                                                </a>
                                                <a href="{{ route('brand.show', $warehouse->id) }}">
                                                    <button class="btn btn-sm btn-icon" title="{{ __('admin.Edit') }}">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form method="POST" action="{{ route('brand.destroy', 0) }}">
                                @method('delete')
                                @csrf
