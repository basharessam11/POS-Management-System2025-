...
@section('page', __('admin.Customer'))
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title"> {!! __('admin.Customer') !!}</h5>
                        ...
                        <table id="products-table"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th></th>
                                    <th>{{ __('admin.Name') }}</th>
                                    <th>{{ __('admin.Total Invoices') }} (EGP)</th>
                                    <th>{{ __('admin.Returns') }} (EGP)</th>
                                    <th>{{ __('admin.Paid') }} (EGP)</th>
                                    <th>{{ __('admin.Previous Balance') }} (EGP)</th>
                                    <th>{{ __('admin.Current Balance') }} (EGP)</th>
                            ...
                            @endif --}}
                                ...
                                @foreach ($customer as $cust)
                                    <tr class="odd">
                                        <td>
                                            <input type="checkbox" value="{{ $cust->id }}"
                                        ...
                                        <td> {{ $cust->name }}</td>
                                        <td>{{ $x1 = $cust->invoices->where('type', '!=', 3)->sum('total') }}
                                        </td>
                                        <td>{{ $x2 = $cust->invoices->where('type', '=', 3)->sum('total') }}
                                        </td>

                                        <td>{{ $x3 = $cust->invoices->where('type', '!=', 3)->sum('paid') + $cust->payments->sum('amount') }}
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-inline-block text-nowrap">
                                                ...
                                                <a href="{{ route('invoice.index') }}?customer_id={{ $cust->id }}">
                                                    <button class="btn btn-sm btn-icon" title="{{ __('admin.Edit') }}">
