                    ...
                    <div class="row gy-4 gy-sm-1">
                        <div class="col-sm-6 col-lg-3">
                            <div
                                ...
                                <div>
                                    <h3 class="mb-2">EGP
                                        {{ number_format($customer->price ?? App\Models\Customer::sum('price'), 2) }}
                                    </h3>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title"> {{ __('admin.Customer Payments') }}
                        </h5>
                    ...
                    <div class="card-datatable table-responsive">
                        <div id="products-table_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                            <div class="card-header d-flex border-top rounded-0 flex-wrap py-md-0">
                                ...
                                <form method="GET" action="{{ route('customer_payments.index') }}">
                                    <div class="row g-2 mb-4">
                                        ...
                                        <div class="col-12 col-md-2">
                                            <label for="type" class="form-label">{{ __('admin.Invoice Type') }}
                                            </label>
                                            <select name="type" id="type" class="form-control">
                                                <option value="">{{ __('admin.All') }}</option>
                                                <option value="receive"
                                                    {{ request('type') == 'receive' ? 'selected' : '' }}>
                                                    {{ __('admin.Receive') }}</option>
                                                <option value="spend" {{ request('type') == 'spend' ? 'selected' : '' }}>
                                                    {{ __('admin.Pay') }}</option>
                                            </select>
                                        </div>
                                ...
                                <div class="d-flex justify-content-start justify-content-md-end align-items-baseline">
                                    <div
                                        ...
                                        <div class="dt-buttons btn-group flex-wrap"> <button
                                            ...
                                            <a
                                                href="{{ route('customer_payments.create', ['customer_id' => $customer->id ?? null]) }}">
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td>
                                            <div class="d-inline-block text-nowrap">
                                                <a href="{{ route('customer_payments.edit', $payment->id) }}">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form method="POST" action="{{ route('customer_payments.destroy', 0) }}">
                                @method('delete')
                                @csrf
