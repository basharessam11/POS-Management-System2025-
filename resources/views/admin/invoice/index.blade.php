...
@section('page', __('admin.Order List'))
                    ...
                    <div class="row gy-4 gy-sm-1">
                        ...
                        <div class="col-sm-6 col-lg-2">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    <h3 class="mb-2">{{ number_format($yesterdayAmount ?? 0, 2) }}</h3>
                                    <p class="mb-0">{{ __('admin.Discounts') }}</p>
                                </div>
                                <div class="avatar">
                                    <span class="avatar-initial rounded bg-label-secondary">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title">{!! __('admin.Invoice') !!}</h5>

                        @if (request('customer_id'))
                            <div class="d-flex gap-2">
                                <a href="{{ route('returns.index', ['customer_id' => request('customer_id')]) }}"
                                    class="btn btn-info">
                                    <i class="bx bx-refresh"></i> {{ __('admin.View Returns') }}
                                </a>

                                <a href="{{ route('customer_payments.index', ['customer_id' => request('customer_id')]) }}"
                                    class="btn btn-success">
                                    <i class="bx bx-wallet"></i> {{ __('admin.View Payments') }}
                                </a>
                            </div>
                        @endif
                    </div>
                                ...
                                <div class="d-flex justify-content-start justify-content-md-end align-items-baseline">
                                    <div
                                        ...
                                        <div class="dt-buttons btn-group flex-wrap"> <button
                                            ...
                                            <a
                                                href="{{ route('invoice.create', ['customer_id' => request('customer_id')]) }}">
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td>
                                            <div class="d-inline-block text-nowrap">
                                                ...
                                                @else
                                                    <a href="{{ route('invoice.print2', $inv->id) }}">
                                                        <button class="btn btn-sm btn-icon"
                                                            title="{{ __('admin.Print') }}">
                                                            <i class="bx bxs-printer"></i>
                                                        </button>
                                                    </a>
                                                    <a href="{{ route('invoice.print3', $inv->id) }}">
                                                        <button class="btn btn-sm btn-icon"
                                                            title="{{ __('admin.Print') }}">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form method="POST" action="{{ route('invoice.destroy', 0) }}">
                                @method('delete')
                                @csrf
