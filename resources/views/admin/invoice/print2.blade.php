@php
    ...
    // تم افتراض أن customer->price هو الرصيد السابق قبل الفاتورة الحالية
    $previous_balance = $invoice->customer->price - $invoice->remaining;
...
<body>
    ...
    <div class="invoice-container">
        ...
        <div class="row invoice-header mb-2">
            <div style="display: flex; justify-content: space-between; width: 100%;"
                ...
                <div class="left text-end">
                    ...
                    <p class="mb-1">اسم العميل: {{ $invoice->user->name }}</p>
                </div>
            </div>
        ...
        <!-- Footer -->
        <div class="row pt-4">
            <div class="col-12 text-center text-muted border-top pt-3">
                <p class="mb-1 fw-bold text-dark">شكراً لزيارتكم</p>
                <small class="d-block">المرتجع خلال 10 ايام والتبديل خلال 15 يوم بالفاتورة ماعدا رمضان والعيد</small>
                <small class="d-block mt-3 text-secondary">تم إنشاء هذه الفاتورة بواسطة النظام الآلي.</small>
            </div>
        </div>
    </div>
