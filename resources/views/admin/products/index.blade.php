                                    ...
                                    <div class="row g-3 align-items-end mb-4">
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <select class="form-control select2" name="brand_id">
                                                <option value="all">{!! __('admin.select') !!} {!! __('admin.All') !!}</option>
                            ...
                            @endif --}}
                                ...
                                @foreach ($products as $product)
                                    <tr class="odd">
                                        ...
                                        <td> {{ $product->name }}</td>
                                        {{-- @dd($product->stocks->first()->warehouse->name) --}}

                                        <td> {{ $product->stocks->first()->branch->name }}</td>
                                        <td> {{ $product->stocks->first()->warehouse->name }}</td>
                                        ...
                                        <td>
                                            <div class="d-inline-block text-nowrap">
                                                ...
                                                <a href="{{ route('barcode.barcode', $product->id) }}">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form method="POST" action="{{ route('products.destroy', 0) }}">
                                @method('delete')
                                @csrf
