                ...
                <div class="col-12 col-lg-12 pt-4 pt-lg-0">
                    <div class="card mb-4">
                        ...
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="card-title m-0">{!! __('admin.Add') !!} {!! __('admin.Returns') !!}</h5>
                                ...
                                <div class="row mb-3 g-3">
                                        ...
                                        <select name="customer_id" class="form-control select2" id="customerSelect"
                                            ...
                                            @foreach ($customers as $customer)
                                                <option {{ request('customer_id') == $customer->id ? 'selected' : '' }}
                                                    value="{{ $customer->id }}" data-balance="{{ $customer->price }}">
                                                    {{ $customer->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <select name="type" class="form-control select2" id="invoiceType" required>
                                            <option value="1">{{ __('admin.Retail') }}</option>
                                            <option value="2">{{ __('admin.Wholesale') }}</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-12 mt-4">
                                        ...
                                        <button type="button" class="btn btn-warning mt-3" id="addReturnRow">
                                            {{ __('admin.Add Return') }}</button>
...
@section('footer')
    ...
    <script>
        $(document).ready(function() {
            ...
            const CACHE_KEY = 'rutern_form_cache';
