                ...
                <div class="col-12 col-lg-12 pt-4 pt-lg-0">
                    <div class="card mb-4">
                        ...
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="card-title m-0">{!! __('admin.Add Supplier Invoice') !!}</h5>
                        ...
                        <div class="card-body">
                            ...
                            {{-- FORM --}}
                            <form action="{{ route('supplier_invoice.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="row mb-3 g-3">
                                        ...
                                        <select name="supplier_id" class="form-control select2" required readonly>
                                            ...
                                            @foreach ($suppliers as $supplier)
                                                <option value="{{ $supplier->id }}" selected
                                                    {{ old('supplier_id', request('id')) == $supplier->id ? 'selected' : '' }}>
                                                    {{ $supplier->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                            ...
                                            <table class="table table-bordered" id="itemsTable">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="min-width: 80px;">{{ __('admin.Stock') }}</th>
                                    ...
                                    <div class="col-12 col-md-6 mt-3">
                                        ...
                                        <input type="number" class="form-control" id="price"
                                            value="{{ $supplier->total }}" readonly value="0">
                                    </div>
