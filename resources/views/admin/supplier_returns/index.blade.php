...
@section('page', __('admin.Supplier Returns'))
                    ...
                    <div class="row gy-4 gy-sm-1">
                        <div class="col-sm-6 col-lg-3">
                            <div
                                ...
                                <div>
                                    <h3 class="mb-2">EGP {{ number_format($totalAmount ?? 0, 2) }}
                                    </h3>

                                    <p class="mb-0">{{ __('admin.Total Purchases') }}</p>
                                </div>
                    ...
                    <div class="card-datatable table-responsive">
                        <div id="products-table_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                            <div class="card-header d-flex border-top rounded-0 flex-wrap py-md-0">
                                ...
                                <form method="GET"
                                    action="{{ route('supplier_returns.index', ['supplier_id' => request('id')]) }}">
                                            ...
                                            <a
                                                ...
                                                <button class="btn btn-secondary add-new btn-primary ms-2" tabindex="0"
                                                    ...
                                                    data-bs-target="#offcanvasEcommerceCategoryList"><span><i
                                                            class="bx bx-plus me-0 me-sm-1"></i>{{ __('admin.Add Returns') }}</span></button>
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td>
                                            <div class="d-inline-block text-nowrap">
                                                <a href="{{ route('supplier_returns.edit', $inv->id) }}">
                                                    <button class="btn btn-sm btn-icon" title="{{ __('admin.Edit') }}">
                                                        <i class="bx bx-edit"></i>
                                                    </button>
                                                </a>
                                                <a href="{{ route('supplier_returns.print2', $inv->id) }}">
                                                    <button class="btn btn-sm btn-icon" title="{{ __('admin.Print') }}">
                                                        <i class="bx bxs-printer"></i>
                                                    </button>
                                                </a>
                                                <a href="{{ route('supplier_returns.print3', $inv->id) }}">
                                                    <button class="btn btn-sm btn-icon" title="{{ __('admin.Print') }}">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form method="POST" action="{{ route('supplier_returns.destroy', 0) }}">
                                @method('delete')
                                @csrf
