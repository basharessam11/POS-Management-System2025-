...
@section('contant')
                ...
                <div class="col-12 col-lg-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="card-title m-0">{!! __('admin.Add') !!} {!! __('admin.Supplier') !!}</h5>
                        ...
                        <div class="card-body">
                            ...
                            {{-- FORM --}}
                            {{-- تمت إضافة ID للنموذج لتسهيل التعامل معه بالجافاسكريبت --}}
    ...
    <script>
        $(document).ready(function() {
            ...
            // --- 1. ثوابت و علامات ---
            const CACHE_KEY = 'suppliers_form_cache'; // مفتاح كاش خاص بصفحة العميل
