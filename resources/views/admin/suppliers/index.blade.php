        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title"> {{ __('admin.Supplier') }}</h5>
                            ...
                            @endif --}}
                                ...
                                @foreach ($suppliers as $supplier)
                                    <tr class="odd">
                                        ...
                                        <td> {{ $supplier->name }}</td>
                                        <td>{{ $x1 = $supplier->invoices->where('type', 0)->sum('total') }}
                                        </td>
                                        <td>{{ $supplier->invoices->where('type', 1)->sum('total') }}
                                        </td>

                                        <td>{{ $x2 = $supplier->invoices->where('type', 0)->sum('paid') + $supplier->payment->sum('amount') }}
                                        </td>
                                        <td> {{ $x1 - $x2 }}</td>
                                        ...
                                        <td>
                                            <div class="d-inline-block text-nowrap">
                                                ...
                                                <a href="{{ route('supplier_invoice.index') }}?id={{ $supplier->id }}">
                                                    <button class="btn btn-sm btn-icon" title="{{ __('admin.Edit') }}">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form method="POST" action="{{ route('suppliers.destroy', 0) }}">
                                @method('delete')
                                @csrf
