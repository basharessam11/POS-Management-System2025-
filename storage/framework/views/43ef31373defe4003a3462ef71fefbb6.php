        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title"> <?php echo __('admin.Warehouses'); ?></h5>
                    ...
                    <div class="card-datatable table-responsive">
                        <div id="products-table_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                            <div class="card-header d-flex border-top rounded-0 flex-wrap py-md-0">
                                ...
                                <form method="GET" action="<?php echo e(route('warehouses.index')); ?>">
                                            ...
                                            <a href="<?php echo e(route('warehouses.create')); ?>">
                                                <button class="btn btn-secondary add-new btn-primary ms-2" tabindex="0"
                                                    ...
                                                    data-bs-target="#offcanvasEcommerceCategoryList"><span><i
                                                        ...
                                                        <?php echo __('admin.Warehouses'); ?></span></button>
                        ...
                        <div class="row mx-2">
                            <?php echo e($warehouses->links('vendor.pagination.bootstrap-5')); ?>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form method="POST" action="<?php echo e(route('warehouses.destroy', 0)); ?>">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\laravel_test\pos\resources\views/admin/warehouses/index.blade.php ENDPATH**/ ?>