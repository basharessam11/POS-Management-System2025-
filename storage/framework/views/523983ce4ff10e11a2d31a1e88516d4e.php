                ...
                <div class="col-12 col-lg-12 pt-4 pt-lg-0">
                    <div class="card mb-4">
                        ...
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="card-title m-0"><?php echo __('admin.Add Returns'); ?></h5>
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?php echo e(route('supplier_returns.store')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="row mb-3 g-3">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <label class="form-label"><?php echo e(__('admin.Supplier')); ?></label>
                                        <select name="supplier_id" class="form-control select2" id="customerSelect" required
                                            ...
                                            <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php echo e(request('supplier_id') == $supplier->id ? 'selected' : ''); ?>

                                                    value="<?php echo e($supplier->id); ?>" data-balance="<?php echo e($supplier->total); ?>">
                                    ...
                                    <div class="d-flex justify-content-end gap-3 mt-4">
                                        <button type="submit" name="save" value="save"
                                            class="btn btn-success"><?php echo e(__('admin.Save')); ?>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\laravel_test\pos\resources\views/admin/supplier_returns/create.blade.php ENDPATH**/ ?>