        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title"> <?php echo __('admin.Brand'); ?></h5>
                    ...
                    <div class="card-datatable table-responsive">
                                            ...
                                            <a href="<?php echo e(route('brand.create')); ?>">
                                                <button class="btn btn-secondary add-new btn-primary ms-2" tabindex="0"
                                                    ...
                                                    data-bs-target="#offcanvasEcommerceCategoryList"><span><i
                                                        ...
                                                        <?php echo __('admin.Brand'); ?></span></button>
                        ...
                        <table id="products-table"
                            ...
                            <tbody>
                                ...
                                <?php $__currentLoopData = $brand; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warehouse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="odd">
                                        <td>
                                        ...
                                        <td>
                                            <div class="d-inline-block text-nowrap">
                                                <a href="<?php echo e(route('brand.edit', $warehouse->id)); ?>">
                        ...
                        <div class="row mx-2">
                            <?php echo e($brand->links('vendor.pagination.bootstrap-5')); ?>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form method="POST" action="<?php echo e(route('brand.destroy', 0)); ?>">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\laravel_test\pos\resources\views/admin/brand/index.blade.php ENDPATH**/ ?>