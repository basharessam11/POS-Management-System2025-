        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title"> <?php echo e(__('admin.Supplier')); ?></h5>
                            ...
                            <tbody>
                                ...
                                <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="odd">
                                        ...
                                        <td><?php echo e($x1 = $supplier->invoices->where('type', 0)->sum('total')); ?>

                                        </td>
                                        <td><?php echo e($supplier->invoices->where('type', 1)->sum('total')); ?>

                                        </td>

                                        <td><?php echo e($x2 = $supplier->invoices->where('type', 0)->sum('paid') + $supplier->payment->sum('amount')); ?>

                                        </td>
                                        <td> <?php echo e($x1 - $x2); ?></td>
                                        <td> <?php echo e($supplier->total); ?></td>
                                        ...
                                        <td>
                                            <div class="d-inline-block text-nowrap">
                                                ...
                                                <a href="<?php echo e(route('supplier_invoice.index')); ?>?id=<?php echo e($supplier->id); ?>">
                                                    <button class="btn btn-sm btn-icon" title="<?php echo e(__('admin.Edit')); ?>">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form method="POST" action="<?php echo e(route('suppliers.destroy', 0)); ?>">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\laravel_test\pos\resources\views/admin/suppliers/index.blade.php ENDPATH**/ ?>