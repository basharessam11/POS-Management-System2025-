<?php $__env->startSection('page', __('admin.Order List')); ?>
                    ...
                    <div class="row gy-4 gy-sm-1">
                        ...
                        <div class="col-sm-6 col-lg-2">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    <h3 class="mb-2"><?php echo e(number_format($yesterdayAmount ?? 0, 2)); ?></h3>
                                    <p class="mb-0"><?php echo e(__('admin.Discounts')); ?></p>
                                </div>
                                <div class="avatar">
                                    <span class="avatar-initial rounded bg-label-secondary">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title"><?php echo __('admin.Invoice'); ?></h5>

                        <?php if(request('customer_id')): ?>
                            <div class="d-flex gap-2">
                                <a href="<?php echo e(route('returns.index', ['customer_id' => request('customer_id')])); ?>"
                                    class="btn btn-info">
                                    <i class="bx bx-refresh"></i> <?php echo e(__('admin.View Returns')); ?>

                                </a>

                                <a href="<?php echo e(route('customer_payments.index', ['customer_id' => request('customer_id')])); ?>"
                                    class="btn btn-success">
                                    <i class="bx bx-wallet"></i> <?php echo e(__('admin.View Payments')); ?>
                    ...
                    <div class="d-flex justify-content-between align-items-center row py-3 gap-3 gap-md-0">
                        ...
                        <?php if(session('success')): ?>
                            ...
                            <script>
                                ...
                                console.log('✅ تم مسح بيانات الكاش بنجاح بعد إرسال النموذج.');
                            </script>
                        <?php endif; ?>
                    ...
                    <div class="card-datatable table-responsive">
                        <div id="products-table_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                            <div class="card-header d-flex border-top rounded-0 flex-wrap py-md-0">
                                ...
                                <form method="GET" action="<?php echo e(route('invoice.index')); ?>">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <select name="type" class="form-control  ">
                                                ...
                                                <option value="1" <?php echo e(request('type') == 1 ? 'selected' : ''); ?>>
                                                    <?php echo e(__('admin.Retail')); ?></option>
                                                <option value="2" <?php echo e(request('type') == 2 ? 'selected' : ''); ?>>
                                                    <?php echo e(__('admin.Wholesale')); ?></option>
                                            </select>
                                        </div>

                                        <div class="col-12 col-md-6 col-lg-2 d-flex align-items-end">
                                            <button type="submit"
                                                class="btn btn-primary w-100 mt-4"><?php echo e(__('admin.Submit')); ?></button>
                                        </div>
                                    </div>
                                </form>
                                ...
                                <div class="d-flex justify-content-start justify-content-md-end align-items-baseline">
                                    <div
                                        ...
                                        <div class="dt-buttons btn-group flex-wrap"> <button
                                            ...
                                            <a
                                                href="<?php echo e(route('invoice.create', ['customer_id' => request('customer_id')])); ?>">
                                                <button class="btn btn-secondary add-new btn-primary ms-2" tabindex="0"
                                                    ...
                                                    data-bs-target="#offcanvasEcommerceCategoryList"><span><i
                                                        ...
                                                        <?php echo __('admin.Invoice'); ?></span></button>
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td>
                                            <div class="d-inline-block text-nowrap">
                                                <a href="<?php echo e(route('invoice.edit', $inv->id)); ?>">
                                                ...
                                                <?php if($inv->type == 1): ?>
                                                    <a href="<?php echo e(route('invoice.print', $inv->id)); ?>">
                                                        <button class="btn btn-sm btn-icon"
                                                            title="<?php echo e(__('admin.Print')); ?>">
                                                            <i class="bx bxs-printer"></i>
                                                        </button>
                                                    </a>
                                                <?php else: ?>
                                                    <a href="<?php echo e(route('invoice.print2', $inv->id)); ?>">
                                                        <button class="btn btn-sm btn-icon"
                                                            title="<?php echo e(__('admin.Print')); ?>">
                                                            <i class="bx bxs-printer"></i>
                                                        </button>
                                                    </a>
                                                    <a href="<?php echo e(route('invoice.print3', $inv->id)); ?>">
                                                        <button class="btn btn-sm btn-icon"
                                                            title="<?php echo e(__('admin.Print')); ?>">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form method="POST" action="<?php echo e(route('invoice.destroy', 0)); ?>">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\laravel_test\pos\resources\views/admin/invoice/index.blade.php ENDPATH**/ ?>