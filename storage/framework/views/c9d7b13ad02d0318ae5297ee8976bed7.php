<?php $__env->startSection('page', __('admin.Products_Management')); ?>
                ...
                <div class="col-12 col-lg-12 pt-4 pt-lg-0">
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="card-title m-0"><?php echo __('admin.Add'); ?> <?php echo __('admin.Products'); ?></h5>
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <select name="warehouse_id" class="form-control select2 " required>
                                            <?php $__currentLoopData = $warehouses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $warehouse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($warehouse->id); ?>" <?php echo e($index == 0 ? 'selected' : ''); ?>>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <input type="text" name="sizes[]"
                                                                    ...
                                                                    value="<?php echo e($size); ?>" readonly>
                                                            </td>
...
<?php $__env->startSection('footer'); ?>
    <script>
        $(document).ready(function() {
            ...
            function clearDraft() {
                if (confirm(
                        '<?php echo e(__('admin.Are you sure you want to delete all saved data and start from scratch?')); ?>'
                    )) {
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\laravel_test\pos\resources\views/admin/products/create.blade.php ENDPATH**/ ?>