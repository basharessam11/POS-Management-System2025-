                    ...
                    <div class="row gy-4 gy-sm-1">
                        <div class="col-sm-6 col-lg-3">
                            <div
                                ...
                                <div>
                                    <h3 class="mb-2">EGP
                                        <?php echo e(number_format($customer->price ?? App\Models\Customer::sum('price'), 2)); ?>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title"> <?php echo e(__('admin.Customer Payments')); ?>
                    ...
                    <div class="card-datatable table-responsive">
                        <div id="products-table_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                            <div class="card-header d-flex border-top rounded-0 flex-wrap py-md-0">
                                ...
                                <form method="GET" action="<?php echo e(route('customer_payments.index')); ?>">
                                    <div class="row g-2 mb-4">
                                        <input type="hidden" name="customer_id" value="<?php echo e($customer->id ?? 0); ?>">
                                        ...
                                        <div class="col-12 col-md-2">
                                            <label for="type" class="form-label"><?php echo e(__('admin.Invoice Type')); ?>
                                            ...
                                            <select name="type" id="type" class="form-control">
                                                ...
                                                <option value="receive"
                                                    ...
                                                    <?php echo e(__('admin.Receive')); ?></option>
                                                <option value="spend" <?php echo e(request('type') == 'spend' ? 'selected' : ''); ?>>
                                                    <?php echo e(__('admin.Pay')); ?></option>
                                            </select>
                                        </div>
                                ...
                                <div class="d-flex justify-content-start justify-content-md-end align-items-baseline">
                                    <div
                                        ...
                                        <div class="dt-buttons btn-group flex-wrap"> <button
                                            ...
                                            <a
                                                href="<?php echo e(route('customer_payments.create', ['customer_id' => $customer->id ?? null])); ?>">
                        ...
                        <table id="products-table"
                            ...
                            <thead>
                                <tr>
                                    <th></th>
                                    <th></th>
                                    <th><?php echo e(__('admin.Invoice Type')); ?>
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td>
                                            <div class="d-inline-block text-nowrap">
                                                <a href="<?php echo e(route('customer_payments.edit', $payment->id)); ?>">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form method="POST" action="<?php echo e(route('customer_payments.destroy', 0)); ?>">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\laravel_test\pos\resources\views/admin/customer_payment/index.blade.php ENDPATH**/ ?>