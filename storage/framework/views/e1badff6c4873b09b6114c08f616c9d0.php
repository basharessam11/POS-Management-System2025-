<?php $__env->startSection('page', __('admin.Customer')); ?>
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title"> <?php echo __('admin.Customer'); ?></h5>
                ...
                <div class="card">
                    ...
                    <div class="card-datatable table-responsive">
                                        ...
                                        <div class="dt-buttons btn-group flex-wrap"> <button
                                            ...
                                            <a href="<?php echo e(route('customer.create')); ?>">
                                                <button class="btn btn-secondary add-new btn-primary ms-2" tabindex="0"
                                                    ...
                                                    data-bs-target="#offcanvasEcommercecustomerList"><span><i
                                                            class="bx bx-plus me-0 me-sm-1"></i><?php echo __('admin.Add'); ?>

                                                        <?php echo __('admin.Customer'); ?></span></button>
                        ...
                        <table id="products-table"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo e(__('admin.Total Invoices')); ?> (EGP)</th>
                                    <th><?php echo e(__('admin.Returns')); ?> (EGP)</th>
                                    <th><?php echo e(__('admin.Paid')); ?> (EGP)</th>
                                    <th><?php echo e(__('admin.Previous Balance')); ?> (EGP)</th>
                                    <th><?php echo e(__('admin.Current Balance')); ?> (EGP)</th>
                            ...
                            <tbody>
                                ...
                                <?php $__currentLoopData = $customer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cust): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="odd">
                                        <td>
                                            <input type="checkbox" value="<?php echo e($cust->id); ?>"
                                        ...
                                        <td><?php echo e($x1 = $cust->invoices->where('type', '!=', 3)->sum('total')); ?>

                                        </td>
                                        <td><?php echo e($x2 = $cust->invoices->where('type', '=', 3)->sum('total')); ?>

                                        </td>

                                        <td><?php echo e($x3 = $cust->invoices->where('type', '!=', 3)->sum('paid') + $cust->payments->sum('amount')); ?>

                                        </td>

                                        <td> <?php echo e($x1 - $x3); ?></td>
                                        <td> <?php echo e($cust->price); ?></td>
                                        ...
                                        <td>
                                            <div class="d-inline-block text-nowrap">
                                                <a href="<?php echo e(route('customer.edit', $cust->id)); ?>">
                                                    <button class="btn btn-sm btn-icon" title="<?php echo e(__('admin.Edit')); ?>">
                                                        <i class="bx bx-edit"></i>
                                                    </button>
                                                </a>
                                                <a href="<?php echo e(route('invoice.index')); ?>?customer_id=<?php echo e($cust->id); ?>">
                                                    <button class="btn btn-sm btn-icon" title="<?php echo e(__('admin.Edit')); ?>">
                        ...
                        <div class="row mx-2">
                            <?php echo e($customer->links('vendor.pagination.bootstrap-5')); ?>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form method="POST" action="<?php echo e(route('customer.destroy', 0)); ?>">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\laravel_test\pos\resources\views/admin/customer/index.blade.php ENDPATH**/ ?>