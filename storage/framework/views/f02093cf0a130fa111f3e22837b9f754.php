<?php $__env->startSection('page', __('admin.Supplier Returns')); ?>
                    ...
                    <div class="row gy-4 gy-sm-1">
                        <div class="col-sm-6 col-lg-3">
                            <div
                                ...
                                <div>
                                    <h3 class="mb-2">EGP <?php echo e(number_format($totalAmount ?? 0, 2)); ?>

                                    </h3>

                                    <p class="mb-0"><?php echo e(__('admin.Total Purchases')); ?></p>
                                </div>
                    ...
                    <div class="card-datatable table-responsive">
                        <div id="products-table_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                            <div class="card-header d-flex border-top rounded-0 flex-wrap py-md-0">
                                ...
                                <form method="GET"
                                    action="<?php echo e(route('supplier_returns.index', ['supplier_id' => request('id')])); ?>">
                                            ...
                                            <a
                                                ...
                                                <button class="btn btn-secondary add-new btn-primary ms-2" tabindex="0"
                                                    ...
                                                    data-bs-target="#offcanvasEcommerceCategoryList"><span><i
                                                            class="bx bx-plus me-0 me-sm-1"></i><?php echo e(__('admin.Add Returns')); ?></span></button>
                            ...
                            <tbody>
                                ...
                                <?php $__currentLoopData = $invoice; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="odd">
                                        ...
                                        <td><?php echo e($inv->supplier->name ?? '-'); ?></td>
                                        ...
                                        <td>
                                            <div class="d-inline-block text-nowrap">
                                                <a href="<?php echo e(route('supplier_returns.edit', $inv->id)); ?>">
                                                    <button class="btn btn-sm btn-icon" title="<?php echo e(__('admin.Edit')); ?>">
                                                        <i class="bx bx-edit"></i>
                                                    </button>
                                                </a>
                                                <a href="<?php echo e(route('supplier_returns.print2', $inv->id)); ?>">
                                                    <button class="btn btn-sm btn-icon" title="<?php echo e(__('admin.Print')); ?>">
                                                        <i class="bx bxs-printer"></i>
                                                    </button>
                                                </a>
                                                <a href="<?php echo e(route('supplier_returns.print3', $inv->id)); ?>">
                                                    <button class="btn btn-sm btn-icon" title="<?php echo e(__('admin.Print')); ?>">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form method="POST" action="<?php echo e(route('supplier_returns.destroy', 0)); ?>">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\laravel_test\pos\resources\views/admin/supplier_returns/index.blade.php ENDPATH**/ ?>