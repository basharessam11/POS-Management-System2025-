                ...
                <div class="col-12 col-lg-12 pt-4 pt-lg-0">
                    <div class="card mb-4">
                        ...
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="card-title m-0"><?php echo __('admin.Add Supplier Invoice'); ?></h5>
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?php echo e(route('supplier_invoice.store')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="row mb-3 g-3">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <label class="form-label"><?php echo e(__('admin.Suppliers')); ?></label>
                                        <select name="supplier_id" class="form-control select2" required readonly>
                                            ...
                                            <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($supplier->id); ?>" selected
                                                    <?php echo e(old('supplier_id', request('id')) == $supplier->id ? 'selected' : ''); ?>>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <label class="form-label"><?php echo __('admin.Date'); ?></label>
                                    ...
                                    <div class="col-12 col-md-6 mt-3">
                                        ...
                                        <input type="number" class="form-control" id="price"
                                            value="<?php echo e($supplier->total); ?>" readonly value="0">
                                    </div>
...
<?php $__env->startSection('footer'); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            const CACHE_KEY = 'supplier_invoice_form_cache';
            ...
            function initSelect2(select) {
                ...
                select.select2({
                    ...
                    dropdownParent: $('body'),
                    ajax: {
                        url: '<?php echo e(route('invoice.search1')); ?>',
                        dataType: 'json',
                        delay: 250,
            ...
            <td><input type="number" name="price[]" class="form-control price" min="0" value="0"  ></td>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\laravel_test\pos\resources\views/admin/supplier_invoice/create.blade.php ENDPATH**/ ?>